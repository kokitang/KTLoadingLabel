...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of KTLoadingLabel.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Koki Tang/KTLoadingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Koki Tang' => 'kokitangwaichun@gmail.com' }
  s.source           = { :git => 'https://github.com/Koki Tang/KTLoadingLabel.git', :tag => s.version.to_s }
